...
const Footer = () => {
  return (
    <footer className="w-full mt-10 bg-gradient-to-r from-purple-400 to-pink-400 text-white rounded-t-lg shadow-lg">
      ...
      <div className="bg-purple-500 py-2 text-center text-sm">
